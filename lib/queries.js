...
/* TAGS */
    ...
    export function insertTermTaxonomy(body){
        ...
        const query =  `INSERT INTO wp_term_taxonomy (term_taxonomy_id, term_id, taxonomy, description, parent, count ) VALUES ('${term_id}', '${term_id}','${taxonomy}','${description}','${parent}','0');`
        return query;
    }
